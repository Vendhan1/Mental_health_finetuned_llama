def prompt_template(data: str, num_records: int = 5):
    ...
    return f"""You are an expert data curator assisting a machine learning engineer in creating a high-quality instruction tuning dataset for finetuning a model to peform well in queries realted to mental health . Your task is to transform 
